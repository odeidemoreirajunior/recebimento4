		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Recebimento 4.0",
									"targetURL": "#linkuprecebimento4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"linkuprecebimento4-display": {
								"semanticObject": "linkuprecebimento4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=linkup.recebimento4",
									"url": sap.ui.require.toUrl("linkup/recebimento4")
								}
							}
						}
					}
